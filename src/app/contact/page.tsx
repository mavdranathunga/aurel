        ...
        <div className={styles.grid}>
          <ScrollReveal>
            <div className={styles.info}>
              ...
              <div className={styles.infoCard}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#25D366" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={styles.infoIcon}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
                <div>
                  <h3 className={styles.infoTitle}>WhatsApp</h3>
                  <p className={styles.infoText}>+94 77 123 4567</p>
                  <p className={styles.infoSubtext}>Available for chat 24/7</p>
                </div>
              </div>
